<!-- Conecta o site às fontes escolhidas do Google Fonts -->
<head>
...
cities <- tibble(
  ...
  dplyr::mutate(tip = tolower(name),
                ...
                tip = glue::glue("<img style='border-radius:40px;' src=https://github.com/IcaroBernardes/carmen_sandiego_DOS/tree/master/www/cities/{tip}.png'>")) %>% 
